...
namespace LibraryApp
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            _usersList.Add(new User("Eli", "Rygg", "Portveien 2"));
            _usersList.Add(new User("Jarl", "Goli", "Portveien 2"));
            _usersList.Add(new User("Espen", "Askeladd", "Rusleveien 23"));
            _usersList.Add(new User("Per", "Askeladd", "Omveien 56"));
            _usersList.Add(new User("Pål", "Askeladd", "Bakveien 69"));
        }
        ...
        {
            var usersWindow = new UsersWindow(this, _library.Books, _usersList);
